    ...
    <main class="clearfix" >
        <section class="info_blocks_wrap child_hdr_banner">
        	<div class="wrapper clearfix">
                <h1>Aircraft</h1>
                <div class="breadcrumbs"><a href="index.php">Home</a><a href="javascript:void(0);">Aircraft</a><a href="javascript:void(0);">Turbo Props</a></div>
            </div>
        </section>
        	...
        	<div class="wrapper clearfix">
                ...
                <div class="child_content_inner inner_fw">
                    <section class="aircraft_page">
                    	<h2 class="blue aircraft_type_h">Turbo Props</h2>
                        ...
                        <h3>Performance <i class="fa fa-angle-double-down blue"></i></h3>
                                    ...
                                    <div class="three_col_box_wrap clearfix">
                                        <div class="three_col_box">
                                            ...
                                            <div class="jet_stat">6-50+ PASSENGERS</div>
                                            <div class="passengers">
                                                ...
                                                <i class="fa fa-user"></i>
                                                <i class="fa fa-user"></i>
                                                <i class="fa fa-user"></i>&nbsp;<span class="lt_grey pass_comment"> (to 50+)</span>
                                            </div>
                                        </div>
                                        <div class="three_col_box">
                                            <div class="jet_stat_label blue">Average cruising speed of:</div>
                                            <div class="jet_stat">200-420 mph</div>
                                        </div>
                                        <div class="three_col_box">
                                            <div class="jet_stat_label blue">Average nonstop range of:</div>
                                            <div class="jet_stat">just over 1,000 miles</div>
                                        </div>
                                    </div>
                                    <hr>
                                    <p><strong>OUR RECOMMENDATION:</strong> The turbo prop is the most cost-efficient aircraft for short-service flights and ideal for short to mid-range flights.</p>
                    </section>
                </div>
            </div>
        </section>
