    ...
    <main class="clearfix" >
        <section class="info_blocks_wrap child_hdr_banner">
        	<div class="wrapper clearfix">
                <h1>Aircraft</h1>
                <div class="breadcrumbs"><a href="index.php">Home</a><a href="javascript:void(0);">Aircraft</a><a href="javascript:void(0);">Mid Sized Jets</a></div>
            </div>
        </section>
        	...
        	<div class="wrapper clearfix">
                ...
                <div class="child_content_inner inner_fw">
                    <section class="aircraft_page">
                    	<h2 class="blue aircraft_type_h">Mid Sized Jets</h2>
                        ...
                        <h3>Performance <i class="fa fa-angle-double-down blue"></i></h3>
                                    ...
                                    <div class="three_col_box_wrap clearfix">
                                        <div class="three_col_box">
                                            ...
                                            <div class="jet_stat">7-8 PASSENGERS</div>
