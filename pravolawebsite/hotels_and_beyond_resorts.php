    ...
    <main class="clearfix" >
        <section class="info_blocks_wrap child_hdr_banner">
        	<div class="wrapper clearfix">
                <h1>Hotels & Beyond Resorts</h1>
                <div class="breadcrumbs"><a href="index.php">Home</a><a href="javascript:void(0);">Elite Member Services</a><a href="javascript:void(0);">Hotels & Beyond Resorts</a></div>
            </div>
        </section>
        	...
        	<div class="wrapper clearfix">
                ...
                <div class="child_content_inner">
                    <section class="page_content">
                        <h2 class="blue">Elite Access to Hotels & Beyond Resorts</h2>
                        <p><img src="images/child_images/elite_member_services/hotels_and_beyond.jpg">Our Elite Members manage an extensive network of preferred partners around the globe. We work with the finest venues hospitality has to offer and extend this exclusive access to these must-stay hotels to our Elite Members.</p>
