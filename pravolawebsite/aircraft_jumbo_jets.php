    ...
    <main class="clearfix" >
        <section class="info_blocks_wrap child_hdr_banner">
        	<div class="wrapper clearfix">
                <h1>Aircraft</h1>
                <div class="breadcrumbs"><a href="index.php">Home</a><a href="javascript:void(0);">Aircraft</a><a href="javascript:void(0);">Jumbo Jets</a></div>
            </div>
        </section>
        	...
        	<div class="wrapper clearfix">
                ...
                <div class="child_content_inner inner_fw">
                    <section class="aircraft_page">
                    	<h2 class="blue aircraft_type_h">Jumbo Jets</h2>
                        ...
                        <h3>Performance <i class="fa fa-angle-double-down blue"></i></h3>
                                    ...
                                    <div class="three_col_box_wrap clearfix">
                                        <div class="three_col_box">
                                            ...
                                            <div class="jet_stat">50+ PASSENGERS</div>
                                            <div class="passengers">
                                                <i class="fa fa-user"></i>
                                                <i class="fa fa-user"></i>
                                                <i class="fa fa-user"></i>
                                                <i class="fa fa-user"></i>
                                                <i class="fa fa-user"></i>&nbsp;<span class="lt_grey pass_comment"> (x10)</span>
                                            </div>
                                        </div>
                                        <div class="three_col_box">
                                            <div class="jet_stat_label blue">Average cruising speed of:</div>
                                            <div class="jet_stat">460-590 mph</div>
                                        </div>
                                        <div class="three_col_box">
                                            <div class="jet_stat_label blue">Average nonstop range of:</div>
                                            <div class="jet_stat">Varies</div>
                                        </div>
                                    </div>
                                    <hr>
                                    <p><strong>OUR RECOMMENDATION:</strong> More commonly known as a commercial airliner, this aircraft class, available through Blue Star Jets, is anything but. Traveling at higher speeds with a greater range, the jumbo jet can fly the globe delivering any entourage to any destination. Whether it's a sports team or a rock tour, this member of the fleet can be configured for executive, coach or even private travel with bedrooms and other amenities you can think of.</p>
                    </section>
                </div>
            </div>
        </section>
