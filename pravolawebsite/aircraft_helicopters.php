    ...
    <main class="clearfix" >
        <section class="info_blocks_wrap child_hdr_banner">
        	<div class="wrapper clearfix">
                <h1>Aircraft</h1>
                <div class="breadcrumbs"><a href="index.php">Home</a><a href="javascript:void(0);">Aircraft</a><a href="javascript:void(0);">Helicopters</a></div>
            </div>
        </section>
        	...
        	<div class="wrapper clearfix">
                ...
                <div class="child_content_inner inner_fw">
                    <section class="aircraft_page">
                    	<h2 class="blue aircraft_type_h">Helicopters</h2>
                        ...
                        <h3>Performance <i class="fa fa-angle-double-down blue"></i></h3>
                                    ...
                                    <div class="three_col_box_wrap clearfix">
                                        <div class="three_col_box">
                                            ...
                                            <div class="jet_stat">4-6 PASSENGERS</div>
                                        ...
                                        <div class="three_col_box">
                                            ...
                                            <div class="jet_stat">150-194 mph</div>
                                        </div>
                                        <div class="three_col_box">
                                            <div class="jet_stat_label blue">Average nonstop range of:</div>
                                            <div class="jet_stat">450-590 miles</div>
                                        </div>
                                    </div>
                                    <hr>
                                    <p><strong>OUR RECOMMENDATION:</strong> Quick on and off the ground and agile in the air.</p>
                    </section>
                </div>
            </div>
        </section>
