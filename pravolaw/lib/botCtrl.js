    ...
    $scope.selectplanefunc = function() {
     ...
     function typing(){
            setTimeout(function () {
            var msg3 = angular.element('<div id="loadchattype" class="loadchattype message new"><figure class="avatar"><img src="lib/img/profile.png" /></figure><img class="imgsize"  src="lib/img/chat.svg" /></div>');
